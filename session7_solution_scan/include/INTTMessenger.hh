...
public:
  ...
  // note : for the INTT box rotation and ladder l1 offset, 2023_07_05
  G4double GetL1Offset() {return L1_offset_;};
  G4double GetINTTBoxRotation() {return INTT_box_rotation_;};
...
private:
  ...
  // note : for the INTT box rotation and ladder l1 offset, 2023_07_05
  G4UIcmdWithADouble* L1_offset_command_;
  G4double L1_offset_;

  G4UIcmdWithADouble* INTT_box_rotation_command_;
  G4double INTT_box_rotation_;
