...
{
  // G4double layer_1_Y_offset = 0.2975;// note : data run 52 U8 (new value assigned, you can check the note on the Notion)
  G4double Vertical_rotation_angle_offset = (INTT_mess_ -> GetINTTBoxRotation() != 0.) ? INTT_mess_ -> GetINTTBoxRotation() * deg : 0. ; // note : data run52 U8 slope offset
...
void EDDetectorConstruction::ConstructLadders()
{
  ...
  G4double layer_1_Y_offset = (INTT_mess_ -> GetL1Offset() != 0.) ? INTT_mess_ -> GetL1Offset() : 0.;// note : data run 52 U8 (new value assigned, you can check the note on the Notion)
  // G4double Vertical_rotation_angle_offset = (INTT_mess_ -> GetINTTBoxRotation() != 0.) ? INTT_mess_ -> GetINTTBoxRotation() : 0. ; // note : data run52 U8 slope offset
